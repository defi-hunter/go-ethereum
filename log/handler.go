...
func RotatingFileHandler(filePath string, limit uint, max_file_num int, formatter Format) (Handler, error) {
	...
	fileWriter := NewAsyncFileWriter(filePath, int64(limit), max_file_num)
	fileWriter.Start()
